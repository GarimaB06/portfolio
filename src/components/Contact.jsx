...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        e.preventDefault();
        emailjs.sendForm('service_kgu8lr6', 'template_ttwdc7s', form.current, 'j2CA0I5ohZ68MHKEw');
        e.target.reset();
    };
            ...
            <div className="contact-content">
                ...
                <div className="contact-info">
                    ...
                    <div className="contact-card">
                        ...
                        <a href="mailto:garima41@gmail.com.com" className="contact-button">
            ...
            <div className="contact-content">
                ...
                <form action="" ref={form} onSubmit={sendEmail} className="contact-form">
                    ...
                    <div className="contact-form-div">
                        ...
                        <input type="email" name="name" className="contact-form-input" placeholder="Insert your email"/>
                    </div>

                    <div className="contact-form-div contact-form-area">
                        <label className="contact-form-tag">Project</label>
                        <textarea name="project" cols="30" rows="10" className="contact-form-input" placeholder="Enter Description"></textarea>
